...
const articleSlugs = [
  "what-is-disposable-email-address-2025-guide",
  "10-reasons-stop-using-real-email-signups",
  "how-to-stop-email-spam-definitive-2025-playbook",
  "what-your-inbox-reveals-about-you-how-to-stop-it",
  "10-minute-mail-for-developers-test-email-flows",
];

const articleDates = ["2025-01-15", "2025-02-03", "2025-03-10", "2025-04-22", "2025-05-18"];
...
export default function BlogSection() {
  ...
  const articles = [1, 2, 3, 4, 5].map((n, i) => ({
    id: n,
    slug: articleSlugs[i],
    category: t(`blog${n}Category`),
    readTime: t(`blog${n}ReadTime`),
    date: articleDates[i],
    title: t(`blog${n}Title`),
    excerpt: t(`blog${n}Excerpt`),
    fullContent: articleFullContent[i],
  }));
